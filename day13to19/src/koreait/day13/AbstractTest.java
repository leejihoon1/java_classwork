...
//		AShape ash = new AShape();  오류 : 추상클래스는 new로 객체 생성 못합니다. -> 오류
		...
		System.out.println("넓이1 : " + tri.getArea());// 부모 클래스의 추상메소드 -> 구체화된 메소드가 실행됩니다.
		System.out.println("넓이 2: " + atri.getArea());
		
		// 새로생긴 triangle() 메소드는 어떤 참조변수로 실행할까요?  정답 : atri
