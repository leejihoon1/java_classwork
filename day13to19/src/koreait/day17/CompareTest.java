...
public class CompareTest {
	...
	public static void main(String[] args) {
		...
		List<String>list2 = new ArrayList<>(); // 문자열 String 은 클래스
		...
		list2.sort(null); // 사정식 정렬(알파벳 순서, 가나다 순서)
...
//		list3.sort(null);
		...
		list3.sort(new MemberNameAcseding());
		System.out.println("Name sort(오름차순 " + list3);
		list3.sort(new MemberNameDecseding());
		System.out.println("Name sort(내림 차순 " + list3);
