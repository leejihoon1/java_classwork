...
public class IntArrayTest { // 정수값 배열을 연습합니다.
	// 배열 : 일반변수는 변수 1개에 데이터 1개 저장합니다. 많은 데이터를 저장할 때 변수를 많이 선언하지 않고 배열을 사용.
	
	public static void main(String[] args) {
		// 배열 변수 선언
		// 1) 초기화를 같이합니다.
		int[]arr1 = {78,65,89,94}; // []베열기호, { } 배열값을 나열  
		...
		// 배열 데이터의 위치 (숫자) : 인덱스, 기호[ ] 사용합니다.
		System.out.println("arr1배열 3번째 데이터의 값 : " + arr1[2]); // 89 
		System.out.println("arr2배열 3번째 데이터의 값 : " + arr2[2]); // 0
		
		// arr1 배열의 모든 값을 출력하고 싶다. 배열의 친구 : for문
		for(int i=0;i<arr1.length;i++) { // i<arr1.length는 배열이 크기가 변경되어도 잘 실행될 수 있습니다.
			System.out.println("arr1["+i+"]의 데이터 값 : " + arr1[i]); // arr1[i]는 i번재 위치 배열의 값
		}
		
		// 배열 특정위치에 데이터를 저장합니다. arr2배열 5번쨰 위치에 78을 저장해보세요.
		arr2[4]=78;
		System.out.println("arr2배열 5번째 데이터의 값 : " + arr2[4]); // 값 78
		...
		System.out.println(arr2); // 주소값 (해시코드라는 식별값)
		
		//발전 방향 : arr2배열의 난수값 만들 때 중복된 값을 제외합니다. 그리고 6개를 한쌍으로 5번 만듭니다. -> Lotto
