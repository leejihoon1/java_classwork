...
public class VariableTest {
	...
	int dval = 123;
	final int fval = 23;
	static final int fval2 = 456; // 값을 변경 할 수 없는 변수 : 상수
//	final int test;  오류 : final 변수는 꼭 초기값을 저장합니다.
	int test2;
	public static void main(String[] args) {
		// 변수가 선언되는 위치로 특성을 이해하기
		...
		*/
		...
		while(true) {
			...
			if(k==12) break;
			System.out.println("sum = " + sum); // main 메소드 { } 안에서 어디서나 사용가능.
		}
...
//		클래스의 일반적으로 기본형 상수 필드를 대문자로 표기합니다.
	...
	void nonStatic(int a) {
		...
		System.out.println("----------------");
//		fval = 100; // fval변수는 값을 변경 할 수 없습니다. -> 오류: final키워드 사용
	}
	// **static에서는 static만 
	//nonstatic에서는 static, nonstatic 둘 다 사용, *nonstatic은 static키워드가 없는 것
}
