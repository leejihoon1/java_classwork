...
//		MyClass1 cls33 = new MyClass1(3.14); // 오류 : 인자의 데이터 타입과 맞는 커스텀 생성자 없음
		...
		System.out.println("f3필드만 초기화"); // double 배열을 만들어서 참조값을 cls4 객체에 전달.
		cls4.print();
		...
		cls4.f3[2] = 999.9912;
		System.out.println("cls5객체 f3[2] 값 확인 : " + cls5.f3[2]); // cls4와 cls5객체의 f3필드는 동일한 배열(주소 같습니다)
		System.out.println("cls5객체 f3[2] 값 확인 : " + cls5.f3[0]);
	}
}
